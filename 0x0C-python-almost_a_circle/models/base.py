...
class Base:
    ...
    0x0C*. Private Class Attributes:__nb_object (int): Number of
    instantiated Bases.
    """
    __nb_objects = 0
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON serialization of a list of objects to a
        file.Args:
    ...
    def from_json_string(json_string):
        ...
        dicts.Returns:if json_string is None or empty - an empty
        list.Otherwise - the Python list represented by json_string.
        """
    ...
    def load_from_file(cls):
        ...
        strings.Reads from `<cls.__name__>.json`.
        Returns:
    ...
    def save_to_file_csv(cls, list_objs):
        """Write the CSV serialization of a list of objects to a
        file.
        Args:
